...
import notebook from "observableMapa";
...
function Mapa() {
  ...
  useEffect(() => {
    ...
    let main = runtime.module(notebook, name => {
      ...
      return ["clearMainWindow","panel","populate","afterInitialLayout","populateMapa","viewof dorling","viewof colorSelect", "color", "dorlingCircleConf","storageUpdate","scatterConfig","biglayoutToggle","updateScatterConfig","reactToMunSelecionados","xaxis","yaxis"].includes(name);
    });
